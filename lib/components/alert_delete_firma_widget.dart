...
import 'alert_delete_firma_model.dart';
export 'alert_delete_firma_model.dart';

class AlertDeleteFirmaWidget extends StatefulWidget {
  const AlertDeleteFirmaWidget({super.key});

  @override
  State<AlertDeleteFirmaWidget> createState() => _AlertDeleteFirmaWidgetState();
}

class _AlertDeleteFirmaWidgetState extends State<AlertDeleteFirmaWidget> {
  late AlertDeleteFirmaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlertDeleteFirmaModel());
  }
