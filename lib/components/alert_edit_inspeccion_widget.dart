...
import 'alert_edit_inspeccion_model.dart';
export 'alert_edit_inspeccion_model.dart';

class AlertEditInspeccionWidget extends StatefulWidget {
  const AlertEditInspeccionWidget({super.key});

  @override
  State<AlertEditInspeccionWidget> createState() =>
      _AlertEditInspeccionWidgetState();
}

class _AlertEditInspeccionWidgetState extends State<AlertEditInspeccionWidget> {
  late AlertEditInspeccionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlertEditInspeccionModel());
  }
          ...
          children: [
            Align(
              ...
              child: Padding(
                ...
                child: Text(
                  '¿Está usted seguro de editar la inspección?',
